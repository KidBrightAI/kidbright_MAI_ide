<template>
  <div class="left-panel d-flex flex-column">
    ...
    <MainMenu
      ...
      @deleteProject="$emit('deleteProject')"
    />
    <div class="left-bottom-content d-flex flex-fill position-relative">
      ...
      <ul class="step">
        ...
        >
          <img
            src="@/assets/images/png/capture.png"
            alt=""
            srcset=""
          >
        </li>
        ...
        >
          <img
            src="@/assets/images/png/annotate.png"
            alt=""
            srcset=""
          >
        </li>
        ...
        >
          <img
            src="@/assets/images/png/train.png"
            alt=""
            srcset=""
          >
        </li>
        ...
        >
          <img
            src="@/assets/images/png/code.png"
            alt=""
            srcset=""
          >
        </li>
      ...
      <div
        v-if="selectedMenu === 1"
        class="pt-3 h-100 overflow-hidden"
      >

...
Blockly.Python['rtc_set_time'] = function(block) {
  ...
  return `RTC().datetime((${value_year}, ${value_month}, ${value_day}, ${value_hour}, ${value_min}, ${value_sec}, 0, 0))\n`
}
...
Blockly.Python['light_sleep'] = function(block) {
  ...
  return `machine.lightsleep(${value_time} * 1000)\n`
}
...
Blockly.Python['deep_sleep'] = function(block) {
  ...
  return `machine.deepsleep(${value_time} * 1000)\n`
}
...
Blockly.Python['send_into_source'] = function(block) {
  ...
  return `print(str(${value_source}) + "=" + str(${value_value}))\n`
}

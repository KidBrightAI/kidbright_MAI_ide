python.pythonGenerator.forBlock['maix3_image_draw_string'] = function(block, generator) {
  ...
  return `${value_image}.draw_string(${value_x}, ${value_y}, str(${value_text}), scale=${value_scale}, color=(${r}, ${g}, ${b}))\n`
}
...
python.pythonGenerator.forBlock['maix3_image_draw_line'] = function(block, generator) {
  ...
  return `${value_image}.draw_line(${value_x1}, ${value_y1}, ${value_x2}, ${value_y2}, color=(${r}, ${g}, ${b}), thickness=${value_thickness})\n`
}
...
python.pythonGenerator.forBlock['maix3_image_draw_rectangle'] = function(block, generator) {
  ...
  return `${value_image}.draw_rectangle(${value_x1}, ${value_y1}, ${value_x2}, ${value_y2}, color=(${r}, ${g}, ${b}), thickness=${value_thickness})\n`
}
...
python.pythonGenerator.forBlock['maix3_image_draw_circle'] = function(block, generator) {
  ...
  return `${value_image}.draw_circle(${value_x1}, ${value_y1}, ${value_radius}, color=(${r}, ${g}, ${b}), thickness=${value_thickness})\n`
}
...
python.pythonGenerator.forBlock['maix3_image_draw_ellipse'] = function(block, generator) {
  ...
  // missing some value
  return `${value_image}.draw_ellipse(${value_x1}, ${value_y1}, ${value_radius_x}, ${value_radius_y}, ${value_rotate}, ${value_angle_start}, ${value_angle_end}, color=(${r}, ${g}, ${b}), thickness=${value_thickness})\n`
}
...
python.pythonGenerator.forBlock['maix3_image_open'] = function(block, generator) {
  ...
  return `${value_var} = image.open("${text_path}")\n`
}

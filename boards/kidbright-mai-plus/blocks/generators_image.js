python.pythonGenerator.forBlock['maix3_image_draw_string'] = function (block, generator) {
  ...
  var value_thickness = generator.valueToCode(block, 'thickness', python.Order.ATOMIC) || "1"
  ...
  return `${value_image}.draw_string(${value_x}, ${value_y}, str(${value_text}), scale=${value_scale}, thickness=${value_thickness}, color=image.Color.from_rgb(${r}, ${g}, ${b}))\n`
}
...
python.pythonGenerator.forBlock['maix3_image_draw_rectangle'] = function (block, generator) {
  ...
  return `${value_image}.draw_rectangle(${value_x1}, ${value_y1}, ${value_x2}, ${value_y2}, color=image.Color.from_rgb(${r}, ${g}, ${b}), thickness=${value_thickness})\n`
}
...
python.pythonGenerator.forBlock['maix3_image_new'] = function (block, generator) {
  ...
  var g = parseInt(colour_color.substring(3, 5), 16)
  var b = parseInt(colour_color.substring(5, 7), 16)
  var code = `image.new(size=(${value_width}, ${value_height}), color=image.Color.from_rgb(${r}, ${g}, ${b}), mode = "RGB")`
